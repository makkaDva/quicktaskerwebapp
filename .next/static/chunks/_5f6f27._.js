(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/_5f6f27._.js", {
...
"[project]/app/post-jobs/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function PostJob() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const { data: { user }, error: authError } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].auth.getUser();
            ...
            // Insert u Supabase
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].from('jobs').insert([
                {
                    ...formData,
...
_s(PostJob, "CsgpVihTJxgITKN/rkvtxWBm9WM=", false, function() {
    return [
...
_c = PostJob;
var _c;
__turbopack_refresh__.register(_c, "PostJob");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_refresh__.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/app/post-jobs/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules)": ((__turbopack_context__) => {
...
//# sourceMappingURL=_5f6f27._.js.map