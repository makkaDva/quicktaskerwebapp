...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setError(null);
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].auth.signInWithPassword({
                email,
                password
            });
            if (error) {
            ...
            // Redirektuj korisnika ili ažuriraj stanje aplikacije
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b180fd._.js.map